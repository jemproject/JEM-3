...
<fieldset>
	...
	<table class="table table-striped" id="el-attachments">
		<tbody>
			...
			<tr>
				<td>
					...
					<div>
						...
						<input type="text" name="attached-name[]" value="<?php echo $file->name; ?>" />
					</div>
					<div>
						<div class="title"><?php echo JText::_('COM_JEM_ATTACHMENT_DESCRIPTION'); ?></div>
						<input type="text" name="attached-desc[]" value="<?php echo $file->description; ?>" />
					</div>
				</td>
				<td>
					<div>
				...
				<td>
					<?php echo JHtml::image('media/com_jem/images/publish_r.png', JText::_('COM_JEM_GLOBAL_REMOVE_ATTACHMENT'), array('id' => 'attach-remove'.$file->id,'class' => 'attach-remove pointer','title'=>JText::_('COM_JEM_GLOBAL_REMOVE_ATTACHMENT'))); ?>
				</td>
			</tr>
			<?php endforeach; ?>
			<tr>
